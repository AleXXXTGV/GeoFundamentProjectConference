        ...
        <div class="container pt-[28px] pb-[20px]">
            <div class="">
                ...
                <ul class="font-medium list-disc list-inside pl-5 mt-[15px]">
                    ...
                    <li class="mt-[15px] 2xl:text-2xl">{{$t('aboutPage.listOneItemTwo')}}</li>
                    <li class="mt-[15px] 2xl:text-2xl">{{$t('aboutPage.listOneItemThree')}}</li>
                    <li class="mt-[15px] 2xl:text-2xl">{{$t('aboutPage.listOneItemFour')}}</li>
                </ul>
            </div>
            <div class="mt-[15px]">
                <span class="font-semibold 2xl:text-2xl">{{$t('aboutPage.listOneTitle')}}</span>
            ...
            <div class="mt-[15px]">
                ...
                <ul class="font-medium list-disc list-inside pl-5 mt-[15px]">
                    ...
                    <li class="mt-[15px] 2xl:text-2xl">{{$t('aboutPage.listFourItemThree')}}</li>
                </ul>
            </div>
        </div>
    </div>
